  ...
  head: () => ({
    meta: [
      ...
      { title: "TrimSwipe — Tinder for Photos with privacy built-in" },
      {
        name: "description",
        content:
          "TrimSwipe your camera roll in minutes. Swipe to keep, trim, or delete — strip metadata and reclaim storage, all on-device.",
      },
      { name: "theme-color", content: "#f5efe6" },
      { property: "og:title", content: "TrimSwipe — Tinder for Photos with privacy built-in" },
      { property: "og:description", content: "TrimSwipe Storage is a photo cleaner that slims your library by compressing images and stripping metadata." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "TrimSwipe — Tinder for Photos with privacy built-in" },
      { name: "description", content: "TrimSwipe Storage is a photo cleaner that slims your library by compressing images and stripping metadata." },
      { name: "twitter:description", content: "TrimSwipe Storage is a photo cleaner that slims your library by compressing images and stripping metadata." },
